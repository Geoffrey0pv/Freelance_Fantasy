...
import { whyShouldYouPickUs } from "../constants/index.js";
    ...
    return (
        <section className="c-space my-5">
            <div className="w-full text-white-600">
                <h3 className="head-text text-center">¿Por qué elegir FreelanceFantasy?</h3>
                <div className="work-container">
                    ...
                    <div className="work-content">
                        <div className="sm:py-10 py-5 sm:px-5 px-2.5">
                            {whyShouldYouPickUs.map(({ id, name, pos, icon, duration, title, animation }) => (
                                <div key={id}
